...
<?php endif; ?>
                    ...
                    <ul class="sidebar-menu">
                        <li>
                            <a href="<?php echo "https://www.facebook.com"; ?>">
...
<!-- articles -->
                        <li class="treeview <?=active_link_controller('license')?>">
                             <a href="#">
                                <i class="fa fa-cogs"></i>
                                <span><?php echo lang('menu_articles'); ?></span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li class="<?=active_link_function('interfaces')?>"><a href="<?php echo site_url('admin/articles'); ?>"><?php echo lang('menu_articles_create'); ?></a></li>
                            </ul>                             
                        </li>
...
<!-- bettips -->
                        <li class="treeview <?=active_link_controller('resources')?>">
                            <a href="#">
                                <i class="fa fa-cogs"></i>
                                <span><?php echo lang('menu_bettips'); ?></span>
                                <i class="fa fa-angle-left pull-right"></i>
                            </a>
                            <ul class="treeview-menu">
                                <li class="<?=active_link_function('interfaces')?>"><a href="<?php echo site_url('admin/bettips'); ?>"><?php echo lang('menu_bettips_create'); ?></a></li>
                            </ul>
                        </li>
